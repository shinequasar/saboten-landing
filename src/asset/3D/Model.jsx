...
export default function Model({ url, ...props }) {
  ...
  const obj = useLoader(OBJLoader,'/cactus.obj')
  useFrame((state) => {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <mesh
        ...
        position={[0.59, -3.79, -17.84]}
        rotation={[0.98, 0.15, 3.24]}
        scale={[0.5, 0.5, 0.5]}
      />
      <mesh
        material={materials.M_Headset}
        geometry={nodes.VR_Headset.geometry}
        position={[32.92, -15.17, 23.59]}
